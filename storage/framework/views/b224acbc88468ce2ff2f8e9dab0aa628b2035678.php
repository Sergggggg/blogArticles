...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Add new article')); ?></div>
                ...
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-primary"><?php echo e(__('Add new article')); ?></button>
                </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/project3/resources/views/formActicle.blade.php ENDPATH**/ ?>